...
def load_data_sanghyeon(path="./project_data/", dataset="paper_author.txt", features = 256):
    ...
    node2vec = Node2Vec(graph=paper_author, # target graph
                        dimensions=features, # embedding dimension
                        walk_length=50, # number of nodes in each walks 
